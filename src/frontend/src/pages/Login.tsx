...
export function Login() {
  ...
  return (
    <div className="min-h-dvh grid lg:grid-cols-2 bg-grad-mesh">
      {/* Brand panel */}
      <div className="hidden lg:flex flex-col justify-between p-12 bg-grad-topbar text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 pointer-events-none">
          <div className="absolute top-10 right-20 h-72 w-72 rounded-full bg-white/20 blur-3xl" />
          <div className="absolute bottom-20 left-20 h-96 w-96 rounded-full bg-violet-300/20 blur-3xl" />
        </div>
        <div className="relative">
          <div className="mb-14 flex items-center gap-3">
            ...
            <span className="text-xl font-bold tracking-tight">KudosApp</span>
          </div>
      ...
      <div className="flex items-center justify-center p-6">
        <form onSubmit={onSubmit} className="w-full max-w-sm space-y-5">
          <div className="lg:hidden flex items-center gap-2 mb-2">
            <div className="grid h-9 w-9 place-items-center rounded-xl bg-grad-brand text-white shadow-soft-lg">
              <Award className="h-4 w-4" />
            </div>
            <span className="text-lg font-bold tracking-tight">KudosApp</span>
          </div>
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Welcome back</h1>
            <p className="mt-1 text-sm text-muted-foreground">Sign in with your Zoho account to continue.</p>
          </div>
          ...
          <div className="space-y-2">
            <Label htmlFor="token">Zoho Access Token</Label>
